...
| --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Back-end**                            | Python • Django • Django Rest Framework • FastAPI • Node.js • Linux • Docker • MongoDB • Redis • dbt                                                                                                                                             |
...
| **Editors**                             | Google Colab • JupyterLab • Jupyter Notebook • VS Code • PyCharm • Vim • Sublime Text                                                                                                                                                            |
| **Git**                                 | Git • GitHub • GitLab • Bitbucket • GitFlow                                                                                                                                                                                                      |
| **Image Processing**                    | OpenCV • Pillow • scikit-image • OpenCV-Python                                                                                                                                                                                                   |
| **Time Series Analysis**                | TSA • Statsmodels • ARIMA • SARIMA • LSTM • Prophet • AutoARIMA                                                                                                                                                                                  |
| **GIS**                                 | ArcGIS • QGIS • GeoPandas • Folium • MapLibre                                                                                                                                                                                                    |
| **DevOps & Cloud**                      | Docker • Kubernetes • Jenkins • GitHub Actions • GitLab CI • AWS (EC2, S3) • Azure • GCP • Terraform • Ansible                                                                                                                                    |
| **Robotics & Embedded**                 | ROS2 • C++ • ESP32 • Arduino • PLC • FreeRTOS • MQTT • Modbus • Gazebo                                                                                                                                                                            |
| **Computer Vision**                     | OpenCV • YOLOv8 • Detectron2 • MediaPipe • dlib • Albumentations                                                                                                                                                                                 |
| **Data Engineering**                    | Apache Airflow • dbt • DVC • MongoDB Atlas • PostgreSQL • Cassandra • Kafka • Spark • Hadoop                                                                                                                                                     |
