...
|                       | **Selected programming languages and Libraries**                                                                                                                                                                                                 |
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🖥️ **Back-end**       | Django • Django Rest Framework • Linux • Docker • MongoDB • DRF with Vue.js • FastAPI • Node.js • Redis • dbt                                                                                                                                     |
...
| ✏️ **Editors**        | Google Colab • JupyterLab • Jupyter Notebook • VS Code • PyCharm                                                                                                                                                                                  |
| 🔧 **Git**            | Git • GitHub • GitLab                                                                                                                                                                                                                            |
| 🖼️ **Image Processing** | OpenCV • Pillow • scikit-image                                                                                                                                                                                                                  |
| 📅 **Time Series Analysis** | TSA • Statsmodels • ARIMA • SARIMA • LSTM                                                                                                                                                                                                    |
| 🗺️ **GIS**            | ArcGIS                                                                                                                                                                                                                                           |
| ☁️ **DevOps**         | Docker • Kubernetes • Jenkins • GitHub Actions • AWS • Terraform                                                                                                                                                                                  |
| 🤖 **Robotics**       | ROS2 • C++ • ESP32 • Arduino • PLC • FreeRTOS • Gazebo                                                                                                                                                                                            |
| 👁️ **Computer Vision** | OpenCV • YOLOv8 • Detectron2 • MediaPipe                                                                                                                                                                                                        |
| ⚙️ **Data Engineering** | Airflow • dbt • DVC • Kafka • Spark                                                                                                                                                                                                             |
