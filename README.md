...
| --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🖥️ **Back-end**                         | Python • Django • Django Rest Framework • FastAPI • Node.js • Linux • Docker • MongoDB • Redis • dbt                                                                                                                                             |
| 🎨 **Front-end**                        | HTML • CSS • Bootstrap • JavaScript • Vue.js • React.js • TypeScript                                                                                                                                                                              |
| 🧠 **Deep Learning**                    | TensorFlow • PyTorch • Keras • caret                                                                                                                                                                                                              |
| 📊 **Machine Learning**                 | scikit-learn • caret • XGBoost • LightGBM                                                                                                                                                                                                         |
| 🐍 **Python**                           | Python • Pandas • NumPy • Statsmodels • datetime • ipywidgets • math • GeoPandas • fastparquet                                                                                                                                                   |
| 📈 **R**                                | R • dplyr • caret • ggplot2                                                                                                                                                                                                                      |
| 🗄️ **SQL**                              | MySQL • PostgreSQL • SQLite • SQLAlchemy                                                                                                                                                                                                         |
| 📉 **Visualization**                    | Matplotlib • Seaborn • ggplot2 • Plotly • Tableau                                                                                                                                                                                                |
| ✏️ **Editors**                          | Google Colab • JupyterLab • Jupyter Notebook • VS Code • PyCharm • Vim • Sublime Text                                                                                                                                                            |
| 🔧 **Git**                              | Git • GitHub • GitLab • Bitbucket • GitFlow                                                                                                                                                                                                      |
| 🖼️ **Image Processing**                 | OpenCV • Pillow • scikit-image • OpenCV-Python                                                                                                                                                                                                   |
| 📅 **Time Series Analysis**             | TSA • Statsmodels • ARIMA • SARIMA • LSTM • Prophet • AutoARIMA                                                                                                                                                                                  |
| 🗺️ **GIS**                              | ArcGIS • QGIS • GeoPandas • Folium • MapLibre                                                                                                                                                                                                    |
| ☁️ **DevOps & Cloud**                   | Docker • Kubernetes • Jenkins • GitHub Actions • GitLab CI • AWS • Azure • GCP • Terraform • Ansible                                                                                                                                             |
| 🤖 **Robotics & Embedded**              | ROS2 • C++ • ESP32 • Arduino • PLC • FreeRTOS • MQTT • Modbus • Gazebo                                                                                                                                                                            |
| 👁️ **Computer Vision**                  | OpenCV • YOLOv8 • Detectron2 • MediaPipe • dlib • Albumentations                                                                                                                                                                                 |
| ⚙️ **Data Engineering**                 | Apache Airflow • dbt • DVC • MongoDB Atlas • PostgreSQL • Cassandra • Kafka • Spark • Hadoop                                                                                                                                                     |
| 🎮 **Simulation & Digital Twin**        | Gazebo • Unity • MATLAB • Simulink • CoppeliaSim • Webots                                                                                                                                                                                         |
| 🧪 **Testing & Quality**                | Pytest • Unittest • Selenium • Postman • Jira • Confluence                                                                                                                                                                                        |
---
